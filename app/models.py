...
class Ingredient:
    def __init__(self, json):
        ...
        self.price: float = float(json['price'])
        self.quantity: int = int(json['quantity'])
...
class Consts:
    def __init__(self, json):
        self.ingredient_mozzarella: int = int(json['ingredient_mozzarella'])
        self.ingredient_pomodoro: int = int(json['ingredient_pomodoro'])
